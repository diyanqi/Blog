...
来自浙江，事一名学生，平时有兴趣会开发一些小程序。

退役 OI 选手，正在专心学习文化课。程序设计仅为兴趣爱好。

## 这是什么

本站用以记录写代码的经验及分享生活。若有纰漏，望您指出。

本站多数的原创文章均采用 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/ "一个著作协议") 协议进行许可。翻译及转载文章不享受任何著作权利。
